    ...
    <div className="w-full h-full flex justify-center items-center ">
      <div className="flex flex-col shadow-lg self-center my-4 gap-4 basis-[30rem] min-h-40 p-6 border-2 border-solid border-stone-300 rounded-lg">
        ...
        <TextField
          ...
          onChange={(e) =>
            setTotalState({ ...totalState, phone: e.target.value })
          }
          error={error}
          helperText={error}
          inputProps={{ style: { textAlign: "center" } }}
        ...
        <TextField
          ...
          onChange={(e) =>
            setTotalState({ ...totalState, password: e.target.value })
          }
        />
        <div className="flex justify-between md:justify-around w-[95%] md:w-[80%] self-center text-sm mt-14">
          <Button
...
```jsx
 ...
 const updateState = (key,newValue) => {
    ...
    setTotalState({ ...totalState, [key]: newValue})
  }
  // totalState = {}
  // updateState('first_name', 'zahra')
  // totalState = {first_name: 'zahra'}
   <TextField
          fullWidth
          label="نام"
          value={totalState.first_name}
