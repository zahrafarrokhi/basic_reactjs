...
create dist folder with main.js inside
(()=>{"use strict";const s=new WeakMap;new class{constructor(t){s.set(this,t)}draw(){console.log("circle with radius:"+s.get(this))}}(1).draw()})();
Point:
If you use src="src/index.js" you don't actually use webpack output, and you load index.js and circle.js file as they are.
If you change src="dist/main.js" you get webpack output
```
### asynchronism
```jsx
//1.callback
...
<!--   function ball1(callback){
 ...
 //
  ...
  setTimeout(()=>{
       ...
       if (true){
        console.log('this ball one reached the end of hill');
         ball2(ball3);
       }
       else { throw new Error ("the ball one failed")}
 ...
 function ball2(ball3){
  ...
  setTimeout(()=>{
       ...
       if (true){
        console.log('this ball two reached the end of hill');
         ball3();
       }
       else { throw new Error ("the ball one failed")}
...
// this ball one reached the end of hill
// this ball two reached the end of hill
// this ball three reached the end of hill
// 6s
...
//out
// the ball one reached the end of hill
// the ball two reached the end of hill
// the ball three reached the end of hill
```
### Promis
```jsx
...
function ball1(){
  return new Promise((resolve,reject)=>{
    if(true){
    resolve("the ball one reached the end of hill");}
    else{
...
function ball2(){
  return new Promise((resolve,reject)=>{
    if(true){
    resolve("the ball two reached the end of hill");}
    else{
...
function ball3(){
  return new Promise((resolve,reject)=>{
    if(true){
    resolve("the ball three reached the end of hill");}
    else{
...
async function ball1(){  
  if(true){
  return("the ball one reached the end of hill");}
  else{
  throw new Error("the ball one failed")}
...
if(true){
return("the ball two reached the end of hill");}
else{
throw new Error("the ball two failed")}
...
if(true){
return("the ball three reached the end of hill");}
else{
